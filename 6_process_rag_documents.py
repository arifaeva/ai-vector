...
# # print(documents)
# # print(documents[0].model_dump().get("page_content"))

# # chroma_client.delete_collection("monopoly-guide") # step ini hanya diperlukan kalau sebelumnya merasa sudah berhasil menulis data, sehingga ini lebih untuk validasi saja
